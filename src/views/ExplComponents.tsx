  ...
  return (
    ...
    >
        ...
        {displayConcepts.map((concept, index) => {
          ...
          return (
            <ConceptExplanationCard
              key={`${concept.field}-${index}`}
              secondary={secondary}
            >
              <CardContent sx={{ padding: "6px !important" }}>
                <ConceptName secondary={secondary}>{concept.field}</ConceptName>
                <ConceptExplanation>
      ...
      {hasMoreConcepts && (
        ...
        >
          <Tooltip
            title={expanded ? "Show fewer concepts" : "Show all concepts"}
          >
            <IconButton
              size="small"
...
export const extractConceptExplanations = (
  table: any
