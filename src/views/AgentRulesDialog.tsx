...
export const AgentRulesDialog: React.FC = () => {
  ...
  const [explorationRules, setExplorationRules] = useState(
    agentRules.exploration
  );
...
`;
  ...
  const ruleCount =
    Number(agentRules.coding && agentRules.coding.trim().length > 0) +
          ...
          <Box sx={{ mb: 3 }}>
            ...
            >
              ...
              <Typography
                ...
                sx={{ ml: 1, fontSize: 12 }}
              >
                (Rules that guide AI agents when generating code to transform
                data and recommend visualizations.)
              </Typography>
            </Typography>
          ...
          <Box>
            ...
            >
              ...
              <Typography
                ...
                sx={{ ml: 1, fontSize: 12 }}
              >
                (Rules that guide AI agents when exploring datasets, generating
                questions, and discovering insights)
              </Typography>
            </Typography>
            <Box
              sx={{
