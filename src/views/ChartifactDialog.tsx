...
export const convertToChartifact = (
  ...
  try {
    ...
    let match;
    const chartReplacements: Array<{
      original: string;
      specReplacement: string;
      dataName: string;
      csvContent: string;
    }> = [];
...
`;
    ...
    result +=
      "\n\n---\ncreated with AI using [DS Visualiser](https://github.com/OrangeCat-Technologies/syntx-ds-visualiser)\n\n";
