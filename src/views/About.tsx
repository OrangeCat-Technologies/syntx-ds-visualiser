...
const screenshots: { url: string; description: string }[] = [
  {
    url: "/data-formulator-screenshot-v0.5.webp",
    description: "Explore consumer price trends from 2005 to 2025",
  },
  {
    url: "/screenshot-movies-report.webp",
    description: "Report: Top directors by their revenue",
  },
  {
    url: "/screenshot-renewable-energy.webp",
    description: "Renewable energy percentage by country",
  },
  {
    url: "/screenshot-unemployment.webp",
    description: "Report: Unemployment rate affected by 2008 financial crisis",
  },
  {
    url: "/screenshot-claude-performance.webp",
    description: "Compare Claude models' performance on different tasks",
  },
];
...
export const About: FC<{}> = function About({}) {
  ...
  useEffect(() => {
    ...
    const prevScreenshot =
      currentScreenshot === 0 ? screenshots.length - 1 : currentScreenshot - 1;
    ...
    >
      ...
      >
        ...
        <Box sx={{ display: "flex", mx: "auto", mt: 4 }}>
          <Typography fontSize={84} sx={{ ml: 2, letterSpacing: "0.05em" }}>
            {toolName}
          </Typography>
        </Box>
        <Typography
        ...
        <Box sx={{ mt: 6, mx: 2 }}>
          ...
          >
            <Typography variant="caption">
              How does DS Visualiser handle your data?
            </Typography>
            <Typography variant="caption" sx={{ mt: 1, textAlign: "left" }}>
              <li>
                <strong>Data Storage:</strong> Uploaded data (csv, xlsx, json,
                clipboard, messy data etc.) is stored in browser's local storage
                only
              </li>
              <li>
                <strong>Data Processing:</strong> Local installation runs Python
                on your machine; online demo sends the data to server for data
                transformations (but not stored)
              </li>
              <li>
                <strong>Database:</strong> Only available for locally installed
                DS Visualiser (a DuckDB database file is created in temp
                directory to store data); not available in online demo
              </li>
              <li>
                <strong>LLM Endpoints:</strong> Small data samples are sent to
                LLM endpoints along with the prompt. Use your trusted model
      ...
      >
        ...
        <Button
          ...
          target="_blank"
          rel="noopener noreferrer"
          href="https://github.com/OrangeCat-Technologies/syntx-ds-visualiser/issues"
        >
          Contact Us
        </Button>
