...
export const loadTextDataWrapper = (
  title: string,
  text: string,
  fileType: string
): DictTable | undefined => {
...
export const createTableFromText = (
  title: string,
  text: string,
  context?: string
): DictTable | undefined => {
  ...
  return createTableFromFromObjectArray(
    title,
    records,
    true,
    undefined,
...
export const createTableFromFromObjectArray = (
  ...
  return {
    ...
    metadata: columnTable.names().reduce(
      (acc, name) => ({
        ...acc,
        [name]: {
...
export const loadBinaryDataWrapper = async (
  title: string,
  ...
  try {
    ...
    workbook.eachSheet((worksheet, sheetId) => {
      ...
      const sheetTable = createTableFromFromObjectArray(
